...
import com.spm.config.security.AuthRealm;
import com.spm.config.security.MyRolesAuthorizationFilter;
import com.spm.config.security.MySessionManager;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(@Qualifier("securityManager") SecurityManager manager){
        ...
        filterChainDefinitionMap.put("/dishonest/**","anon");
